(() => {
  ...
  const shell = () => {
    ...
    header.innerHTML = '<div class="app-shell-page-title">运营后台</div><nav class="app-shell-role-tabs" aria-label="角色视图"><b>总部运营</b><span>区域督导</span><span>门店店长</span></nav><a class="app-shell-identity" href="/accounts/">当前身份：读取中</a><button class="app-shell-logout" type="button">退出</button>';
