(() => {
  ...
  const shell = () => {
    ...
    header.innerHTML = '<div class="app-shell-logo"><i>◈</i>小笼包门店运营</div><span class="app-shell-divider"></span><span class="app-shell-meta">库存、任务与盘点闭环</span><span class="app-shell-badge">演示环境</span><a class="app-shell-identity" href="/accounts/">当前身份：读取中</a>';
  ...
  const updateIdentity = async () => {
    ...
    try {
      ...
      const account = payload.active_account;
