(() => {
  ...
  const shell = () => {
    ...
    side.innerHTML = `<div class="app-shell-group"><div class="app-shell-group-title">业务总览</div><a class="app-shell-link${active('/')}" href="/"><i>◈</i>运营中心</a></div><div class="app-shell-group"><div class="app-shell-group-title">库存管理</div><a class="app-shell-link${active('/ledger')}" href="/ledger/"><i>▤</i>库存台账</a><a class="app-shell-link${active('/diagnosis')}" href="/diagnosis/"><i>◎</i>库存研判</a><a class="app-shell-link${active('/simulator')}" href="/simulator/"><i>↹</i>库存模拟器</a><a class="app-shell-link${active('/knowledge')}" href="/knowledge/"><i>◇</i>知识库</a></div><div class="app-shell-group"><div class="app-shell-group-title">日常运营</div><a class="app-shell-link${active('/count-plans')}" href="/count-plans/"><i>□</i>盘点计划</a><a class="app-shell-link${active('/documents')}" href="/documents/"><i>▧</i>库存单据</a><a class="app-shell-link${active('/transfers')}" href="/transfers/"><i>⇄</i>调拨管理</a></div><div class="app-shell-group"><div class="app-shell-group-title">第三方外部工具</div><a class="app-shell-link${active('/sync')}" href="/sync/"><i>↗</i>飞书同步</a><a class="app-shell-link${active('/notifications')}" href="/notifications/"><i>◌</i>机器人推送</a></div>`;
