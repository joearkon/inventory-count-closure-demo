(() => {
  ...
  const shell = () => {
    ...
    header.innerHTML = '<div class="app-shell-logo"><i>◈</i>小笼包门店运营</div><span class="app-shell-divider"></span><span class="app-shell-meta">库存、任务与盘点闭环</span><span class="app-shell-badge">演示环境</span><a class="app-shell-identity" href="/accounts/">当前身份：读取中</a><button class="app-shell-logout" type="button">退出</button>';
    const side = document.createElement('aside'); side.className = 'app-shell-side';
    side.innerHTML = `<div class="app-shell-group"><div class="app-shell-group-title">业务总览</div><a class="app-shell-link${active('/')}" href="/"><i>◈</i>运营中心</a></div><div class="app-shell-group"><div class="app-shell-group-title">库存管理</div><a class="app-shell-link${active('/ledger')}" href="/ledger/"><i>▤</i>库存台账</a><a class="app-shell-link${active('/flows')}" href="/flows/"><i>⇅</i>库存流水</a><a class="app-shell-link${active('/diagnosis-v3')}" href="/diagnosis-v3/"><i>◎</i>库存研判</a><a class="app-shell-link${active('/simulator')}" href="/simulator/"><i>↹</i>库存模拟器</a></div><div class="app-shell-group"><div class="app-shell-group-title">日常运营</div><a class="app-shell-link${active('/count-plans')}" href="/count-plans/"><i>□</i>盘点计划</a><a class="app-shell-link${active('/purchase-orders')}" href="/purchase-orders/"><i>🛒</i>订货管理</a><a class="app-shell-link${active('/receipt-orders')}" href="/receipt-orders/"><i>▣</i>收货管理</a><a class="app-shell-link${active('/documents')}" href="/documents/"><i>▧</i>库存单据</a><a class="app-shell-link${active('/transfers')}" href="/transfers/"><i>⇄</i>调拨管理</a></div><div class="app-shell-group"><div class="app-shell-group-title">第三方外部工具</div><a class="app-shell-link${active('/sync')}" href="/sync/"><i>↗</i>飞书同步</a><a class="app-shell-link${active('/notifications')}" href="/notifications/"><i>◌</i>机器人推送</a></div><div class="app-shell-group"><div class="app-shell-group-title">系统配置</div><a class="app-shell-link${active('/accounts')}" href="/accounts/"><i>♙</i>账户与角色</a></div>`;
    if (prototypeShell) side.insertAdjacentHTML('afterbegin', '<div class="prototype-side-brand"><i>库</i><span>库存研判</span></div>');
